/*!
 * nuxt-legacy-edge v2.0.0-25629050.054ea79 (c) 2016-2018
...
var createRoutes = function createRoutes(files, srcDir, pagesDir) {
  ...
  files.forEach(function (file) {
    ...
    keys.forEach(function (key, i) {
      ...
      var sanitizedKey = key.indexOf('_') === 0 ? key.replace('_', '') : key;
      route.name = route.name ? route.name + '-' + sanitizedKey : sanitizedKey;
      route.name += key === '_' ? 'all' : '';
      route.chunkName = file.replace(/\.(vue|js)$/, '');

      var child = ___default.find(parent, {
        name: route.name
      });
  ...
  build: {
    ...
    filenames: {
      ...
      css: function css(_ref3) {
        ...
        return isDev ? '[name].js' : '[contenthash].css';
      },
...
var name = "nuxt-edge";
var version = "2.0.0-25629050.054ea79";
...
function errorMiddleware(err, req, res, next) {
  ...
  var sendResponse = function sendResponse(content) {
    ...
    res.setHeader('Content-Length', Buffer.byteLength(content)); // Send Response
...
function () {
  function Renderer(nuxt) {
    ...
    this.nuxt = nuxt;
    this.options = nuxt.options; // Will be set by createRenderer
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 12:
                ...
                _APP = "<div id=\"__nuxt\">".concat(this.resources.loadingHTML, "</div>") + BODY_SCRIPTS; // Detect 404 errors
              ...
              case 34:
                serializedSession = "window.__NUXT__=".concat(serialize(context.nuxt, {
                  isJSON: true
                }), ";");
    ...
    value: function configFromFile() {
      ...
      for (var _i = 0; _i < _arr.length; _i++) {
        ...
        for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
          ...
          if (fs.existsSync(path__default.resolve(dir, file))) {
            var postcssConfigPath = path__default.resolve(dir, file);
            return {
  ...
  _createClass(WebpackBaseConfig, [{
    ...
    value: function env$$1() {
      ...
      ___default.each(this.options.env, function (value, key) {
        env$$1['process.env.' + key] = ['boolean', 'number'].indexOf(_typeof(value)) !== -1 ? value : JSON.stringify(value);
      });
    ...
    value: function alias() {
      ...
      return _ref = {
        ...
        '@': path__default.join(srcDir),
        '@@': path__default.join(rootDir)
      }, _defineProperty(_ref, assetsDir, path__default.join(srcDir, assetsDir)), _defineProperty(_ref, staticDir, path__default.join(srcDir, staticDir)), _ref;
    }
  }, {
    key: "rules",
      ...
      return [{
        ...
        exclude: function exclude(file) {
          ...
          if (/node_modules/.test(file)) {
            ...
            try {
              for (var _iterator = [/\.vue\.js/].concat(_this.options.build.transpile)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function (_WebpackBaseConfig) {
  ...
  _createClass(WebpackClientConfig, [{
    ...
    value: function extendConfig() {
      var config = _get(_getPrototypeOf(WebpackClientConfig.prototype), "extendConfig", this).apply(this, arguments);
      ...
      if (!this.options.dev && !config.optimization.minimizer) {
        ...
        var terserJsPlugin = new TerserWebpackPlugin({
          parallel: true,
        ...
        config.optimization.minimizer.push(terserJsPlugin); // https://github.com/NMFR/optimize-css-assets-webpack-plugin
        // https://github.com/webpack-contrib/mini-css-extract-plugin#minimizing-for-production
        // TODO: Remove OptimizeCSSAssetsPlugin when upgrading to webpack 5

        if (this.options.build.extractCSS) {
          var optimizeCSSPlugin = new OptimizeCSSAssetsPlugin({});
...
function () {
  function Builder(nuxt) {
    ...
    this.options = nuxt.options; // Fields that set on build
  ...
  _createClass(Generator, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee8(_ref7) {
        var route, _ref7$payload, payload, _ref7$errors, errors, html, pageErrors, res, minifyErr, _path, page;
